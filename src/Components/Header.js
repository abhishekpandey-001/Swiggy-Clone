    ...
    <header className="bg-[#ff5200] font-serif">
      <div className="flex justify-between mx-16 py-8">
        ...
        <div className="text-white text-base font-bold flex gap-12 items-center">
          ...
          <a
            className="border border-black py-3 px-4 rounded-2xl bg-black"
            href="https://www.swiggy.com/corporate/"
          >
            Sign in
          </a>
      ...
      <div className="pt-16 pb-8 relative">
        <img
          className="h-110 w-60 absolute left-0 top-0"
          src="https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto/portal/testing/seo-home/Veggies_new.png"
        ></img>
        <img
          className="h-110 w-60 absolute right-0 top-0"
        ...
        <div className="max-w-[70%] mx-[26%] mt-[2%] flex gap-5">
          <input
            className="bg-white h-15 w-80 rounded-2xl px-7 py-6 text-[15px]"
            placeholder="Delhi, India"
          ></input>
          <input
            className="bg-white h-15 w-110 rounded-2xl px-7 py-6 text-[15px] flex-wrap"
            placeholder="Search for resturants and items for more"
          ></input>
        </div>
      </div>
